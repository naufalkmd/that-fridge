...
const REASON_LABEL: Record<string, string> = {
  ...
  chat_pdf: "Quick Chat (PDF)",
  chat_tools: "Quick Chat (tools)",
  chat_refund: "Chat refund",
  icon: "Icon generation",
  icon_refund: "Icon refund",
  expiry_scan: "Expiry scan",
  expiry_scan_refund: "Expiry scan refund",
  receipt_scan: "Receipt scan",
  receipt_scan_refund: "Receipt scan refund",
  photo_scan: "Fridge photo scan",
  photo_scan_refund: "Fridge photo scan refund",
  label_scan: "Nutrition label scan",
  label_scan_refund: "Nutrition label scan refund",
