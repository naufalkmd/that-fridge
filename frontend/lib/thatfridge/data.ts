...
export const SECTIONS: Section[] = [
  {
    ...
    name: "Dairy shelf",
    items: [
      { id: "d1", name: "Whole milk", icon: "milk", freshness: 78, days: 6, note: "Best before Tue", qty: 1, shopUrl: null },
      { id: "d2", name: "Greek yogurt", icon: "yogurt", freshness: 54, days: 3, note: "2 tubs left", qty: 2, shopUrl: null },
      { id: "d3", name: "Cheddar block", icon: "cheese", freshness: 88, days: 12, note: "Just opened", qty: 1, shopUrl: null },
      { id: "d4", name: "Salted butter", icon: "cheese", freshness: 95, days: 20, note: "Barely touched", qty: 1, shopUrl: null },
    ],
  },
  {
    id: "produce",
    name: "Produce drawer",
    items: [
      { id: "p1", name: "Spinach", icon: "spinach", freshness: 22, days: 1, note: "Wilting fast", qty: 1, shopUrl: null },
      { id: "p2", name: "Apples", icon: "apple", freshness: 71, days: 9, note: "4 left", qty: 4, shopUrl: null },
      { id: "p3", name: "Carrots", icon: "carrot", freshness: 65, days: 8, note: "Half bag", qty: 1, shopUrl: null },
      { id: "p4", name: "Blueberries", icon: "berries", freshness: 34, days: 2, note: "Small punnet", qty: 1, shopUrl: null },
      { id: "p5", name: "Eggs", icon: "eggs", freshness: 60, days: 10, note: "7 remaining", qty: 7, shopUrl: null },
    ],
  },
  {
    id: "protein",
    name: "Protein bin",
    items: [
      { id: "r1", name: "Chicken thighs", icon: "meat", freshness: 41, days: 2, note: "Use or freeze", qty: 1, shopUrl: null },
      { id: "r2", name: "Ground beef", icon: "meat", freshness: 18, days: 1, note: "Cook tonight", qty: 1, shopUrl: null },
      { id: "r3", name: "Eggs (spare)", icon: "eggs", freshness: 82, days: 14, note: "Backup carton", qty: 1, shopUrl: null },
    ],
  },
  {
    id: "leftovers",
    name: "Leftovers row",
    items: [
      { id: "l1", name: "Roast veggies", icon: "leftovers", freshness: 30, days: 2, note: "From Sunday", qty: 1, shopUrl: null },
      { id: "l2", name: "Pasta bake", icon: "leftovers", freshness: 12, days: 1, note: "Last portion", qty: 1, shopUrl: null },
      { id: "l3", name: "Soup", icon: "leftovers", freshness: 66, days: 4, note: "Quart jar", qty: 1, shopUrl: null },
    ],
  },
];
