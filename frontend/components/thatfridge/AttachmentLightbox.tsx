    ...
    >
      <div onClick={(e) => e.stopPropagation()} style={{ position: "relative", maxWidth: "100%", maxHeight: "100%" }}>
        {attachment.type === "video" ? (
          <video src={attachment.url} controls autoPlay playsInline style={{ maxWidth: "100%", maxHeight: "80vh", borderRadius: 14, display: "block" }} />
        ) : (
          <img src={attachment.url} alt="" style={{ maxWidth: "100%", maxHeight: "80vh", borderRadius: 14, display: "block" }} />
        )}
        <div
          onClick={onClose}
          style={{
